...
SET @msg = N'Did you mean to run this whole script?' + CHAR(10)
    + N'MAKE SURE YOU ARE RUNNING AGAINST A TEST ENVIRONMENT ONLY!';RAISERROR(@msg,20,1) WITH LOG;
GO
...
-- *********************************************************
RAISERROR('An NCI that is NOT - N-O-T aligned', 0, 1) WITH NOWAIT
-- *********************************************************
...
--ALTER INDEX NCOrderNameOrdersDailyNonAligned ON OrdersDaily REBUILD;
--GO
